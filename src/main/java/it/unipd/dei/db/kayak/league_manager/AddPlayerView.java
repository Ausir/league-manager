...
public class AddPlayerView {
	...
	private void setUpContent() {
		...
		mainlLayout.addComponent(new Label("Name"));
		final TextField nameField = new TextField();
		mainlLayout.addComponent(nameField);

		mainlLayout.addComponent(new Label("Birthday"));
		HorizontalLayout dateLayout = new HorizontalLayout();
		final TextField dayField = new TextField("Day");
		dateLayout.addComponent(dayField);
		final TextField monthField = new TextField("Month");
